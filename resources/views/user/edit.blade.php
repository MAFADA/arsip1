            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="letter_number" class="form-control" placeholder="Nomor Surat" value="{{$archive->letter_number}}">
                        @error('letter_number')
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="category" id="category">
                            @foreach($category as $cat)
                                @if($cat->id == $archive->category)
                                    <option value="{{$cat->id}}" selected>{{$cat->archive_category}}</option>
                                @endif
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Judul:</strong>
                        <input type="text" name="title" class="form-control" placeholder="Judul" value="{{$archive->title}}">
                        @error('title')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
